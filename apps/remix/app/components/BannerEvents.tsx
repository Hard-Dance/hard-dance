...
export const BannerEvents = () => {
	return (
		<>
			<div className="banner-events-stars" data-variant="1" />
			<div className="banner-events-stars" data-variant="2" />
			<div className="banner-events-stars" data-variant="3" />

			{/* Logo title text for screen readers since logo title svgs are decorative images */}
			<VisuallyHidden as="h1">Hard.Dance</VisuallyHidden>
			...
			<div className="banner-events-alert">
				...
				>
					<svg aria-hidden="true">
						<use xlinkHref="/assets/symbols.svg#close" />
					</svg>
				</button>
			</div>
		</>
